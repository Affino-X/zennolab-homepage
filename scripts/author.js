...
function renderPost(post) {
    ...
    const postContainer = document.getElementById('postAuthor')
...
async function main() {
    ...
    const renderPosts = () => {
        ...
        if (postStart >= allPosts.length) {
            document.getElementById('loadMoreAuthor').style.display = 'none';
        }
    };

    
    document.getElementById('loadMoreAuthor').addEventListener('click', renderPosts);
    ...
    const searchPosts = (query) => {
      ...
      document.getElementById('searchInputAuthor').addEventListener('input', (event) => {
        ...
        if(query != '') {
    		...
    		document.getElementById('loadMoreAuthor').style.display = 'block';
            const postContainer = document.getElementById('postAuthor');
            postContainer.innerHTML = '';
